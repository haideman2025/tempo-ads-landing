...
const ASSETS = {
  ...
  motionReservation: "/manus-storage/1-3_488cdaeb.mp4",
  ...
  return <div className="night-site">
    ...
    <main id="top">
      ...
      <section className="waitlist-section" aria-label="Khép lại câu chuyện TEMPO">
        ...
        <div className="waitlist-form-wrap waitlist-form-wrap--closing"><div className="waitlist-topline"><span>QUAY LẠI FORM ĐĂNG KÝ</span><span>{claimed.toLocaleString("vi-VN")} / 1.000 chai đã được giữ</span></div><h2>Chỉ còn<br />một bước nữa.</h2><p className="form-intro">Form đăng ký nằm ngay sau phần mở đầu để bạn chọn số lượng, để lại thông tin liên hệ và nhận xác nhận quyền mua TEMPO 3ml.</p><button type="button" onClick={goToWaitlist} className="teal-button">Quay lại form đăng ký <ArrowUpRight size={18} /></button><p className="data-note"><Mail size={14} /> Không yêu cầu địa chỉ hay thanh toán ở bước này.</p></div>
      </section>
